...
export class TokenizerWasm {
    ...
    */
    constructor(json) {
        try {
            ...
            wasm.tokenizerwasm_from_buffer(retptr, ptr0, len0);
            ...
            return TokenizerWasm.__wrap(r0);
        } finally {
    ...
    */
    encode(text, add_special_tokens) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.tokenizerwasm_encode(retptr, this.ptr, ptr0, len0, add_special_tokens);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    decode(tokens, skip_special_tokens) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.tokenizerwasm_decode(retptr, this.ptr, addBorrowedObject(tokens), skip_special_tokens);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('tokenizers-wasm_bg.wasm', import.meta.url);
    }
    const imports = getImports();
