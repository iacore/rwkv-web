...
* @returns {string}
*/
  decode(tokens: any, skip_special_tokens: boolean): string;
}
...
export interface InitOutput {
  ...
  readonly tokenizerwasm_from_buffer: (a: number, b: number, c: number) => void;
  readonly tokenizerwasm_encode: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly tokenizerwasm_decode: (a: number, b: number, c: number, d: number) => void;
